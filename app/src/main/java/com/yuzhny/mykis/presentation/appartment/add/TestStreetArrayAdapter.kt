...
import kotlinx.android.synthetic.main.drop_down_item_second.view.*
...
class StreetArrayAdapter @Inject constructor(@ApplicationContext context: Context, addressList:List<AddressEntity>)
    ...
    private fun initView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.drop_down_item_second , parent,false)
        view.street_address.text =  address!!.street
        view.street_id.text = address.streetId.toString()
        return view
    }
}