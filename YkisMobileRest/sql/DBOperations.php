...
//   $sql = 'SELECT "0" as raion_id , "Выберите район" as raion UNION SELECT t2.raion_id , t2.raion FROM YIS.RAION as t2 WHERE t2.raion_id in (1,3,4,5,2,6,7,11,12)';
    ...
    WHERE t1.address_id = ' . $address_id . ' ORDER BY t1.data DESC  '. $limit . ' ';
            ...
            if($house_id == 22){
                $sql = 'SELECT t1.address_id , "total" as service , "none" as service1 , "none" as service2 , "none" as service3 , "none" as service4,  "20230101" as data ,  t2.dolg + t3.dolg + t4.dolg + t5.dolg as dolg1  , t6.dolg + t7.dolg + t8.dolg +
    ...
    LEFT JOIN YIS.VODA as t2 on t1.address_id = t2.address_id and t2.data ="20230101"
    LEFT JOIN YIS.STOKI as t3 on t1.address_id = t3.address_id and t3.data = "20230101"
    LEFT JOIN YIS.AVODA as t4 on t1.address_id = t4.address_id and t4.data = "20230101"
    LEFT JOIN YIS.ASTOKI as t5 on t1.address_id = t5.address_id and t5.data = "20230101"
    LEFT JOIN YIS.OTOPLENIE as t6 on t1.address_id = t6.address_id and t6.data = "20230101"
    LEFT JOIN YIS.ATEPLO as t7 on t1.address_id = t7.address_id and t7.data = "20230101"
    LEFT JOIN YIS.PTN as t8 on t1.address_id = t8.address_id and t8.data = "20230101"
    LEFT JOIN YIS.PODOGREV as t9 on t1.address_id = t9.address_id and t9.data = "20230101"
    LEFT JOIN YIS.TBO as t10 on t1.address_id = t10.address_id and t10.data = "20230101"
    LEFT JOIN OSBB.KVARTPLATA as t11 on t1.address_id = t11.address_id and t11.data = "20230101"
    LEFT JOIN OSBB.RFOND as t12 on t1.address_id = t12.address_id and t12.data = "20230101"
    ...
    LEFT JOIN YIS.PODOGREV as t9 on t1.address_id = t9.address_id and t9.data = "20230101"
    LEFT JOIN YIS.TBO as t10 on t1.address_id = t10.address_id and t10.data = "20230101"
    LEFT JOIN YIS.KVARTPLATA as t11 on t1.address_id = t11.address_id and t11.data = "20230101"
    WHERE t1.address_id = '.$address_id.' ';
            }
        }
        // print_r($sql);
